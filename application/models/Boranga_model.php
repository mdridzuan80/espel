...
class Boranga_model extends MY_Model
{
    ...
    public function sen_tidak_jawab($sen_jabatan,$tahun)
    {
        $sql = "SELECT * FROM (SELECT b.nama, a.nokp, a.tajuk, 'PENGGUNA' AS cipta, a.stat_soal_selidik_a, year(a.tkh_mula) as tahun, b.jabatan_id as jabatan_id, b.gred_id, b,skim_id, b.kelas_id
            ...
            a.stat_hadir = 'L'
            UNION
            SELECT espel_profil.nama, espel_permohonan_kursus.nokp, espel_kursus.tajuk, 'PENYELARAS' AS cipta, espel_kursus.stat_soal_selidik_a, year(espel_kursus.tkh_mula) as tahun, espel_kursus.ptj_jabatan_id_created as jabatan_id, espel_profil.gred_id, espel_profil,skim_id, espel_profil.kelas_id
            FROM espel_kursus
